...
const Course = ({ match }) => {
  ...
  return (
    <div className="px-2 md:px-8 space-y-4 divide-y divide-gray-300 ">
...
function PageTop(props){
  return(
    <div class="pb-2 md:pb-4 rounded-lg bg-blue-500 shadow-md">
      <img class="sm:h-32 md:h-96 w-full object-cover rounded-t-lg" src={college} alt=""/>
      <div class="px-2 md:px-8 py-2 md:py-4 text-white">
...
function OverviewTab(props) {
  return (
    <div className="lg:flex lg:space-x-32 lg:space-y-0 space-y-8 px-4 py-4">
      <BasicInformation length={props.length} rating={props.rating}/>
      <CourseModules />
    </div>
  );
}
...
function BasicInformation(props){
  return(
    <div className="space-y-4 text-md text-gray-600">
      <h3 className="inline-block pr-2">Course Length:</h3>
      <h3 className="inline-block">{props.length} </h3>
      <div class="space-y-2">
        <h3 className="inline-block">Average Rating:</h3>
...
function CourseModules(props){
  return(
    <div className="space-y-4 text-gray-600">
      ...
      <div className="md:flex md:space-x-16 md:space-y-0 space-y-8 pt-2">
        <div>
...
function CostTab(props) {
  return (
    <div className="relative text-white text-md text-center">
      ...
      <img class="xl:pl-8 place-self-center object-cover h-full" src={Cost_Tab_Circle} alt="" />

      <div class="absolute top-4 inset-0 space-y-6">
        <div>
